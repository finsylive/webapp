...
export default function JobApplyPage() {
  ...
  if (started) {
    return <ApplicationFlow type="job" listingId={id} listingTitle={title} />;
  }
        ...
        <div className="rounded-2xl border border-border bg-card p-6 space-y-4 mb-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Your profile will be analyzed against this role&apos;s requirements and scored.</p>
            </div>
          </div>
